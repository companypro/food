...
class HomeController extends GetxController {
  ...
  getBranchList() async {
    ...
    if (branchData.data != null && branchData.data != null) {
  ...
  getPopularItemDataList() async {
    ...
    if (popularItemData != null && popularItemData.data != null) {
  ...
  getFeaturedItemDataList() async {
    ...
    if (featuredItemData != null && featuredItemData.data != null) {
  ...
  getActiveOrderList() async {
    ...
    if (activeOrder != null && activeOrder.data != null) {
